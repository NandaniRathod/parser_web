...
<!-- Mirrored from thewebmax.org/jobzilla/dash-candidates.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Mar 2023 11:45:30 GMT -->
<head>
...
<body>
	...
	<div class="page-wraper">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="ID-ACCOUNT_dropdown">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="{{ route('logout') }}" onclick="event.preventDefault();
                                                        document.getElementById('logout-form').submit();"><i class="fa fa-share-square"></i> Logout</a></li>
        ...
        <nav id="sidebar-admin-wraper">
            <div class="page-logo">
                <a href="#"><img src="{{asset('/images/MSU_logo_nobg.png')}}" alt=""></a>
            </div>
            
            <div class="scroll-wrapper admin-nav scrollbar-macosx" style="position: relative;"><div class="admin-nav scrollbar-macosx scroll-content scroll-scrolly_visible" style="height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 168.004px;">
                <ul>
                    <li  class="{{ Request::is('upload') ? 'active' : '' }}">
                        <a href="{{route('upload.index')}}"><i class="fa fa-file-upload"></i><span class="admin-nav-text">Upload</span></a>
                    </li>
                    {{-- <li>
                    ...
                    <li>
                    	<a href="javascript:;"><i class="fa fa-suitcase"></i><span class="admin-nav-text">Jobs</span></a><div class="fa fa-angle-right submenu-toogle"></div>
                        <ul class="sub-menu">
                    ...
                    <li class="{{ Request::is('resume') ? 'active' : '' }}">
                        <a href="{{route('resume.index')}}"><i class="fa fa-user-friends"></i><span class="admin-nav-text">Candidates</span></a>
                    </li>
                    <li class="{{ Request::is('bookmark') ? 'active' : '' }}">
                        <a href="{{route('bookmark.index')}}"><i class="fa fa-bookmark"></i><span class="admin-nav-text">Bookmark Resumes</span></a>
                    </li>
        ...
        <div class="modal fade twm-model-popup" id="logout-dash-profile" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"  aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="site-button" data-bs-dismiss="modal">No</button>
                    <button type="button" class="site-button outline-primary"href="{{ route('logout') }}" onclick="event.preventDefault();
